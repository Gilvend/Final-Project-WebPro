              ...
              <div className="panel-body">
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <textarea name="editor1" className="form-control" placeholder="Page Body" defaultValue={"                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat debitis quo saepe voluptate laborum facere perferendis unde ex amet, voluptatum adipisci molestias autem reiciendis, molestiae repellendus tempore, ut explicabo quaerat. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat debitis quo saepe voluptate laborum facere perferendis unde ex amet, voluptatum adipisci molestias autem reiciendis, molestiae repellendus tempore, ut explicabo quaerat. \n                "} />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Add Meta Description..." defaultValue="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis, optio aut voluptatibus voluptatem sit. Quod ab autem, provident, debitis fugit inventore earum nobis assumenda, quos perspiciatis nesciunt dolorum. Ducimus, laudantium. " />
                  </div>
