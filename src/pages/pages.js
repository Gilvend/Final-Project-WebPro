      ...
      <div className="container">
        ...
        <div id="navbar" className="collapse navbar-collapse">
          <ul className="nav navbar-nav">
            ...
            <li className="active"><a href="pages.html">Pages</a></li>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-10">
            <h1><span className="glyphicon glyphicon-cog" aria-hidden="true" /> Pages <small>Manager Site Page</small></h1>
          </div>
              ...
              <div className="panel-body">
                <div className="row">
                  <div className="col-md-12">
                    <input type="text" className="form-control" placeholder="Filter Pages..." />
                  </div>
                  <br />
